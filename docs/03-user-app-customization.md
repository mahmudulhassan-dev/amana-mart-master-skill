# Customer App UI & Theme Customization
...
Table of Contents
  ...
  * Share web url for React web (Only for User App)
...
If you want to customize the onboarding title and content then follow these steps : 
  ...
  * Open **< project>/assets/language/en.json**. At the top, you will find texts with keys like**“all_your_needs_in_one_app” , “order_food_groceries_medicines_parcels”**. Simply change the values without changing the keys. Repeat the same process for all mentioned languages.
  ...
  * If you wish to update the graphics on the onboarding page, go to /assets/images/ and replace onboard.svg , onboard_3.png and onboard_2.png with your preferred png files.
...
If you are using a **React website,** then follow these steps. Go to **lib/util/app_constants.dart** file, add your **React Web hosted URL,** like this –
...
If you don’t want to share the store, then in **lib/util/app_constants.dart** file, just add an empty webHostedUrl.
...
Then there will not be a share option in store details page.

#### Share This Article :

  * [![Facebook](https://6ammart.app/wp-content/plugins/betterdocs/assets/static/images/social/facebook.svg?v=4.8.1)](https://www.facebook.com/sharer/sharer.php?u=https://6ammart.app/documentation/user-application-configuration/customisation/)
  * [![X](https://6ammart.app/wp-content/plugins/betterdocs/assets/static/images/social/twitter.svg?v=4.8.1)](https://twitter.com/intent/tweet?url=https://6ammart.app/documentation/user-application-configuration/customisation/)
  * [![LinkedIn](https://6ammart.app/wp-content/plugins/betterdocs/assets/static/images/social/linkedin.svg?v=4.8.1)](https://www.linkedin.com/shareArticle?mini=true&url=https://6ammart.app/documentation/user-application-configuration/customisation/)
  * [![Pinterest](https://6ammart.app/wp-content/plugins/betterdocs/assets/static/images/social/pinterest.svg?v=4.8.1)](https://pinterest.com/pin/create/button/?url=https://6ammart.app/documentation/user-application-configuration/customisation/)



 Mandatory SetupsApp Build & Release 
