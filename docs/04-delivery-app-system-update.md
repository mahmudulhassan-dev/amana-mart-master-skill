# Deliveryman App Version Update Guide
...
Suppose your system’s current version is V 2.0, now you want to update your system to V2.1 and also want to force users to update the system then you can follow this to update your system safely. 
  ...
  * Generate your appbundle for PlayStore and ipa for AppStore using your update version’s code, in this case V 2.1. And must add this version on your project’s **lib/util/app_constants.dart** file-
...
#### Share This Article :
  ...
  * [![Facebook](https://6ammart.app/wp-content/plugins/betterdocs/assets/static/images/social/facebook.svg?v=4.8.1)](https://www.facebook.com/sharer/sharer.php?u=https://6ammart.app/documentation/deliveryman-application-configuration/deliveryman-app-system-update/)
  * [![X](https://6ammart.app/wp-content/plugins/betterdocs/assets/static/images/social/twitter.svg?v=4.8.1)](https://twitter.com/intent/tweet?url=https://6ammart.app/documentation/deliveryman-application-configuration/deliveryman-app-system-update/)
  * [![LinkedIn](https://6ammart.app/wp-content/plugins/betterdocs/assets/static/images/social/linkedin.svg?v=4.8.1)](https://www.linkedin.com/shareArticle?mini=true&url=https://6ammart.app/documentation/deliveryman-application-configuration/deliveryman-app-system-update/)
  * [![Pinterest](https://6ammart.app/wp-content/plugins/betterdocs/assets/static/images/social/pinterest.svg?v=4.8.1)](https://pinterest.com/pin/create/button/?url=https://6ammart.app/documentation/deliveryman-application-configuration/deliveryman-app-system-update/)



 App Build & ReleasePrerequisites 
