...
This documentation will be applicable for Vendor app 
...
The vendor app requires addon activation in order to function properly.

  * Navigate to the **Addon Activation** section in the Admin Panel.
  * Enter your **CodeCanyon username**.
  * Enter the **purchase code** of your Vendor app.
...
Without addon activation, the vendor app will not work.
