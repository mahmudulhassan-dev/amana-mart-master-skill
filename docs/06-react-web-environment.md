...
Great!! As now you have installed the [NodeJs](https://nodejs.org/en/download) successfully, now you just have to install NPM or Yarn. Below we have given the easy documentation.
...
[ Prerequisite]()[Mandatory setup (Admin panel) ]()
